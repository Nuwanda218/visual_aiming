...
class Config:
    ...
    servo_near_gain: float = 0.035
    servo_far_gain: float = 1.55
    servo_arrival_radius: float = 125.0
    servo_near_brake: float = 0.85
    servo_brake_radius: float = 85.0
    ...
    servo_step_limit: int = 48
    servo_max_speed: float = 2719.0
    servo_max_accel: float = 32000.0
    ...
    servo_overshoot_guard_enabled: bool = True
    servo_overshoot_guard_radius: float = 80.0
    ...
    mouse_diagnostics_enabled: bool = False
    ...
    fps_max_speed: float = 7200.0
    fps_decel_radius: float = 135.0
    fps_near_speed_scale: float = 0.10
    fps_brake_radius: float = 90.0
    fps_brake: float = 0.72
    fps_measurement_blend: float = 0.85
    fps_reacquire_distance: float = 180.0
    fps_jitter_angle: float = 0.0
    fps_jitter_distance: float = 180.0
    fps_velocity_feedback: float = 0.0
